...
using YoderZone.Extensions.Remarker.Remarker.Service.Indexes;
...
public class RemarkerService : IRemarkerService, IRemarkerSettings
{
    ...
    public void OnSettingsChanged()
    {
        ...
        var h = this.FormatSettingsChanged;
        if (h == null)
        {
            return;
        }
    ...
    public string ReadValue(string valueName)
    {
        ...
        Trace.WriteLine(
            string.Format("RemarkerService::ReadValue: Invalid valueName: {0}",
                          valueName));
